...
namespace Task04._4
{
    ...
    {
        private SqlConnection NorthwindConnection = new SqlConnection("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=NORTHWND;Data Source=MSI\\MSSQLSERVER04");
